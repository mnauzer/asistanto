...
final class Acl
{
    ...
    const PERMISSION_VIEW_MENU_DNES = 'view menu dnes';
    const PERMISSION_VIEW_MENU_ZAKAZKA = 'view menu zakazka';
    const PERMISSION_VIEW_MENU_ZOZNAMY = 'view menu zoznamy';
    const PERMISSION_VIEW_MENU_ADRESAR = 'view menu adresar';
    const PERMISSION_VIEW_MENU_EVIDENCIA = 'view menu evidencia';
    const PERMISSION_VIEW_MENU_ZAKAZKY = 'view menu zakazky';
    ...
    const PERMISSION_EVIDENCIA_MANAGE = 'manage evidencia';
    const PERMISSION_DELETE_MANAGE = 'manage delete';

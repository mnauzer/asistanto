...
class CreateIncomesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('incomes', function (Blueprint $table) {
            ...
            $table->bigInteger('income_category_id')->unsigned()->nullable()->default(NULL);
            $table->bigInteger('account_id')->unsigned()->nullable()->default(NULL);
            $table->bigInteger('incomeable_id')->unsigned()->nullable()->default(NULL);
            $table->string('incomeable_type', 50)->nullable()->default(NULL);
            $table->bigInteger('relateable_id')->unsigned()->nullable()->default(NULL);
            $table->string('relateable_type', 50)->nullable()->default(NULL);

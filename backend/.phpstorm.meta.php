...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/rasto/asistanto/backend/public/storage' => 'string',
...
'filesystems.links./home/rasto/asistanto/backend/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'broadcasting.connections.null.driver','dompdf.show_warnings','dompdf.public_path','dompdf.convert_entities','dompdf.options.font_dir',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','activitylog.enabled','activitylog.delete_records_older_than_days',
...
'activitylog.database_connection','backup.backup.name','backup.backup.source.files.include','backup.backup.source.files.exclude','backup.backup.source.files.follow_links',
...
'backup.cleanup.retry_delay','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'MAIL_FROM_ADDRESS','MAIL_FROM_NAME','SANCTUM_STATEFUL_DOMAINS','SESSION_DOMAIN','CORS_ALLOWED_ORIGINS',
'APP_TIMEZONE','CACHE_PREFIX','SESSION_SECURE_COOKIE','CORS_PATHS',);
